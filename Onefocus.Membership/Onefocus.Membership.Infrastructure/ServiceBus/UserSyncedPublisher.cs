...
{
    public record UserSyncedPublishMessage(Guid Id, string Email, string FirstName, string LastName, string? Description, bool ActiveFlag, string? EncryptedPassword): IUserSyncedMessage;
