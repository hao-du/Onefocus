...
{
    public static readonly Error QueryIsRequired = new("QueryIsRequired", "Query is required.");
    ...
    public static readonly Error PerformSearchError = new("IndexError", "Perform search failed.");
}