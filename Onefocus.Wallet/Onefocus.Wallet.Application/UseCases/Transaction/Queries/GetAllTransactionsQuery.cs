...
public sealed record TransactionQueryResponse(Guid Id, DateTimeOffset TransactedOn, Guid CurrencyId, TransactionType Type, decimal Amount, string? Description);
