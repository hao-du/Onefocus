...
using Onefocus.Wallet.Infrastructure.Databases.DbContexts.Read.Configurations.TransactionTypes;

namespace Onefocus.Wallet.Infrastructure.Databases.DbContexts.Read;

public class WalletReadDbContext(DbContextOptions<WalletReadDbContext> options) : DbContext(options)
{
