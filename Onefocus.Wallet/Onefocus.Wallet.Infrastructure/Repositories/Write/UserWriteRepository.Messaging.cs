...
{
    public static UpsertUserRepositoryRequest Cast(IUserSyncedMessage source) => new(source.Id, source.Email, source.FirstName, source.LastName, source.Description, source.ActionFlag, Guid.Empty);
